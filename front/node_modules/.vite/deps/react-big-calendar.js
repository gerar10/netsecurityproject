...
import {
  ...
  usePrevious,
  useUncontrolledProp
} from "./chunk-CFVZK4RJ.js";
import "./chunk-LMKMSGST.js";
import {
  _extends,
  _objectWithoutPropertiesLoose
} from "./chunk-4K42C5TU.js";
import {
  arrow_default,
...
} from "./chunk-DTKEIHU3.js";
import {
  require_warning
} from "./chunk-RWVFAYQT.js";
import {
  require_react_dom
} from "./chunk-6IIS3HCN.js";
import {
  require_prop_types
} from "./chunk-VMVBTF76.js";
import "./chunk-DSEE4GSB.js";
import {
  require_react
...
var EventCell = function(_React$Component) {
  ...
  _createClass(EventCell2, [{
    ...
    value: function render() {
      ...
      var content = import_react11.default.createElement("div", {
        className: "rbc-event-content",
        title: tooltip || void 0
      }, Event2 ? import_react11.default.createElement(Event2, {
        event,
      ...
      return import_react11.default.createElement(EventWrapper, Object.assign({}, this.props, {
        type: "date"
      }), import_react11.default.createElement("div", Object.assign({}, props, {
        tabIndex: 0,
...
function Pop(_ref2) {
  ...
  return import_react11.default.createElement("div", {
    ...
    return import_react11.default.createElement(EventCell, {
      key: idx,
      type: "popup",
      localizer,
      event,
...
var Popup = import_react11.default.forwardRef(function(props, ref) {
  return import_react11.default.createElement(Pop, Object.assign({}, props, {
    popperRef: ref
  }));
});
Popup.propTypes = {
...
function CalOverlay(_ref) {
  ...
  var popperRef = (0, import_react11.useRef)(null);
  if (!overlay.position)
    return null;
  ...
  return import_react11.default.createElement(Overlay_default, {
    rootClose: true,
    flip: true,
    show: true,
    placement: "bottom",
    ...
    return import_react11.default.createElement(Popup, Object.assign({}, props, {
      containerRef,
      ref: popperRef,
      target: overlay.target,
      offset: offset2,
...
var PopOverlay = import_react11.default.forwardRef(function(props, ref) {
  return import_react11.default.createElement(CalOverlay, Object.assign({}, props, {
    containerRef: ref
  }));
});
  ...
  _createClass(BackgroundCells2, [{
    ...
    value: function render() {
      ...
      return import_react11.default.createElement("div", {
        ...
        return import_react11.default.createElement(Wrapper, {
          key: index,
          value: date2,
          range: range3
        }, import_react11.default.createElement("div", {
...
var EventEndingRow = function(_React$Component) {
  ...
  _createClass(EventEndingRow2, [{
    ...
    value: function renderShowMore(segments, slot) {
      ...
      return count ? import_react11.default.createElement("button", {
        type: "button",
        key: "sm_" + slot,
  ...
  return memoizeOne(function(options) {
    ...
    return {
      ...
      getSlotForDate: function getSlotForDate(date2) {
        return range3.find(function(r2) {
...
var DateContentRow = function(_React$Component) {
  ...
  function DateContentRow2() {
    ...
    _this.renderDummy = function() {
      ...
      }, renderHeader && import_react11.default.createElement("div", {
        className: "rbc-row",
        ref: _this.headingRowRef
      }, range3.map(_this.renderHeadingCell)), import_react11.default.createElement("div", {
        className: "rbc-row",
    ...
    _this.containerRef = (0, import_react11.createRef)();
    _this.headingRowRef = (0, import_react11.createRef)();
    _this.eventRowRef = (0, import_react11.createRef)();
  ...
  _createClass(DateContentRow2, [{
    ...
    value: function render() {
      ...
      return import_react11.default.createElement("div", {
        ...
        role: "rowgroup",
        ref: this.containerRef
      }, import_react11.default.createElement(BackgroundCells, {
        localizer,
        date: date2,
        getNow: getNow2,
        rtl,
      ...
      }, range3.map(this.renderHeadingCell)), import_react11.default.createElement(ScrollableWeekComponent, null, import_react11.default.createElement(WeekWrapper, Object.assign({
        isAllDay
      }, eventRowProps), levels.map(function(segs, idx) {
        return import_react11.default.createElement(EventRow, Object.assign({
          key: idx,
          segments: segs
        }, eventRowProps));
      }), !!extra.length && import_react11.default.createElement(EventEndingRow, Object.assign({
        segments: extra,
...
var DateHeader = function DateHeader2(_ref) {
  ...
  if (!drilldownView) {
    return import_react11.default.createElement("span", null, label);
  }
...
var MonthView = function(_React$Component) {
  ...
  function MonthView2() {
    ...
    _this.renderWeek = function(week, weekIdx) {
      ...
      return import_react11.default.createElement(DateContentRow, {
        key: weekIdx,
    ...
    _this.readerDateHeading = function(_ref) {
      ...
      return import_react11.default.createElement("div", Object.assign({}, props, {
        className: clsx_m_default(className, isOffRange && "rbc-off-range", isCurrent && "rbc-current"),
        role: "cell"
      }), import_react11.default.createElement(DateHeaderComponent, {
        label,
        date: date2,
        drilldownView,
        isOffRange,
    ...
    _this.containerRef = (0, import_react11.createRef)();
    _this.slotRowRef = (0, import_react11.createRef)();
    _this._bgRows = [];
  ...
  _createClass(MonthView2, [{
    ...
    value: function renderHeaders(row) {
      ...
      return localizer.range(first, last2, "day").map(function(day2, idx) {
        ...
        }, import_react11.default.createElement(HeaderComponent, {
          date: day2,
          localizer,
    ...
    value: function renderOverlay() {
      ...
      return import_react11.default.createElement(PopOverlay, {
        overlay,
        accessors,
        localizer,
        components: components2,
...
function noOverlap(_ref) {
  ...
  for (var _i2 = 0; _i2 < styledEvents.length; ++_i2) {
    ...
    for (var _j2 = 0; _j2 < se.friends.length; ++_j2) {
      if (se.friends[_j2].idx !== void 0)
        bitmap[se.friends[_j2].idx] = 0;
    }
...
var TimeSlotGroup = function(_Component) {
  ...
  _createClass(TimeSlotGroup2, [{
    ...
    value: function render() {
      ...
      var _this$props$component2 = _this$props$component.timeSlotWrapper, Wrapper = _this$props$component2 === void 0 ? NoopWrapper : _this$props$component2;
      ...
      return import_react11.default.createElement("div", Object.assign({
        ...
        return import_react11.default.createElement(Wrapper, {
          ...
          value,
          resource
        }, import_react11.default.createElement("div", Object.assign({}, slotProps, {
...
function TimeGridEvent(props) {
  ...
  var inner = [import_react11.default.createElement("div", {
    key: "1",
    className: "rbc-event-label"
  }, label), import_react11.default.createElement("div", {
    key: "2",
    className: "rbc-event-content"
  }, Event2 ? import_react11.default.createElement(Event2, {
    event,
  ...
  return import_react11.default.createElement(EventWrapper, Object.assign({
    type: "time"
  }, props), import_react11.default.createElement("div", {
    onClick,
    onDoubleClick,
    style: eventStyle,
    onKeyPress,
...
var DayColumnWrapper$1 = import_react11.default.forwardRef(function(props, ref) {
  return import_react11.default.createElement(DayColumnWrapper, Object.assign({}, props, {
    innerRef: ref
  }));
});
...
var DayColumn = function(_React$Component) {
  ...
  function DayColumn2() {
    ...
    _this.renderEvents = function(_ref) {
      ...
      return styledEvents.map(function(_ref2, idx) {
        ...
        return import_react11.default.createElement(TimeGridEvent, {
          style,
          event,
          label,
          key: "evt_" + idx,
  ...
  _createClass(DayColumn2, [{
    ...
    value: function render() {
      ...
      var _dayProp = dayProp(max2), className = _dayProp.className, style = _dayProp.style;
      var DayColumnWrapperComponent = components2.dayColumnWrapper || DayColumnWrapper$1;
      return import_react11.default.createElement(DayColumnWrapperComponent, {
        ref: this.containerRef,
        date: date2,
        style,
        ...
        return import_react11.default.createElement(TimeSlotGroup, {
          key: idx,
          group: grp,
          resource,
          getters,
      ...
      }), import_react11.default.createElement(EventContainer, {
        localizer,
        resource,
        accessors,
        getters,
      ...
      }))), selecting && import_react11.default.createElement("div", {
        className: "rbc-slot-selection",
        style: {
          top,
          height: height2
        }
      }, import_react11.default.createElement("span", null, localizer.format(selectDates, "selectRangeFormat"))), isNow && this.intervalTriggered && import_react11.default.createElement("div", {
...
var TimeGutter = function TimeGutter2(_ref2) {
  ...
  var _useMemo = (0, import_react11.useMemo)(
    function() {
      return adjustForDST({
        min: min2,
        max: max2,
  ...
  var _useState = (0, import_react11.useState)(getSlotMetrics({
    min: start,
    max: end,
    timeslots,
    step,
  ...
  var renderSlot = (0, import_react11.useCallback)(function(value, idx) {
    if (idx)
      return null;
  ...
  return import_react11.default.createElement(TimeGutterWrapper, {
    slotMetrics
  }, import_react11.default.createElement("div", {
...
var TimeGutter$1 = import_react11.default.forwardRef(function(props, ref) {
  return import_react11.default.createElement(TimeGutter, Object.assign({
    gutterRef: ref
  }, props));
});
var ResourceHeader = function ResourceHeader2(_ref) {
  var label = _ref.label;
  return import_react11.default.createElement(import_react11.default.Fragment, null, label);
};
  ...
  _createClass(TimeGridHeader2, [{
    ...
    value: function renderHeaderCells(range3) {
      ...
      return range3.map(function(date2, i) {
        ...
        var header = import_react11.default.createElement(HeaderComponent, {
          date: date2,
          label,
          localizer
        });
        ...
        }, drilldownView ? import_react11.default.createElement("button", {
          type: "button",
          className: "rbc-button-link",
          onClick: function onClick(e) {
            return _this2.handleHeaderClick(date2, drilldownView, e);
          }
        }, header) : import_react11.default.createElement("span", null, header));
      });
    }
  }, {
    key: "render",
    value: function render() {
      ...
      }, TimeGutterHeader && import_react11.default.createElement(TimeGutterHeader, null)), resources.map(function(_ref, idx) {
        var _ref2 = _slicedToArray(_ref, 2), id = _ref2[0], resource = _ref2[1];
        return import_react11.default.createElement("div", {
          className: "rbc-time-header-content",
          key: id || idx
        }, resource && import_react11.default.createElement("div", {
          className: "rbc-row rbc-row-resource",
          key: "resource_".concat(idx)
        }, import_react11.default.createElement("div", {
          className: "rbc-header"
        }, import_react11.default.createElement(ResourceHeaderComponent, {
          index: idx,
          label: accessors.resourceTitle(resource),
          resource
        }))), import_react11.default.createElement("div", {
          className: "rbc-row rbc-time-header-cell".concat(range3.length <= 1 ? " rbc-time-header-cell-single-day" : "")
        }, _this3.renderHeaderCells(range3)), import_react11.default.createElement(DateContentRow, {
          isAllDay: true,
          rtl,
          getNow: getNow2,
          minRows: 2,
...
var TimeGrid = function(_Component) {
  ...
  function TimeGrid2(props) {
    ...
    _this.scrollRef = import_react11.default.createRef();
    _this.contentRef = import_react11.default.createRef();
    _this._scrollRatio = null;
    _this.gutterRef = (0, import_react11.createRef)();
    return _this;
  }
  _createClass(TimeGrid2, [{
    ...
    value: function renderEvents(range3, events, backgroundEvents, now) {
      var _this2 = this;
      var _this$props = this.props, min2 = _this$props.min, max2 = _this$props.max, components2 = _this$props.components, accessors = _this$props.accessors, localizer = _this$props.localizer, dayLayoutAlgorithm = _this$props.dayLayoutAlgorithm;
      ...
      return resources.map(function(_ref, i) {
        ...
        return range3.map(function(date2, jj) {
          ...
          return import_react11.default.createElement(DayColumn, Object.assign({}, _this2.props, {
            localizer,
    ...
    value: function render() {
      ...
      }, import_react11.default.createElement(TimeGridHeader, {
        range: range3,
        events: allDayEvents,
        width,
        rtl,
      ...
      }, import_react11.default.createElement(TimeGutter$1, {
        date: start,
        ref: this.gutterRef,
        localizer,
    ...
    value: function measureGutter() {
      ...
      this.measureGutterAnimationFrameRequest = window.requestAnimationFrame(function() {
        ...
        var width = (_this3$gutterRef = _this3.gutterRef) !== null && _this3$gutterRef !== void 0 && _this3$gutterRef.current ? getWidth(_this3.gutterRef.current) : void 0;
...
var Day = function(_React$Component) {
  ...
  _createClass(Day2, [{
    key: "render",
    value: function render() {
      var _this$props = this.props, date2 = _this$props.date, localizer = _this$props.localizer, _this$props$min = _this$props.min, min2 = _this$props$min === void 0 ? localizer.startOf(new Date(), "day") : _this$props$min, _this$props$max = _this$props.max, max2 = _this$props$max === void 0 ? localizer.endOf(new Date(), "day") : _this$props$max, _this$props$scrollToT = _this$props.scrollToTime, scrollToTime = _this$props$scrollToT === void 0 ? localizer.startOf(new Date(), "day") : _this$props$scrollToT, _this$props$enableAut = _this$props.enableAutoScroll, enableAutoScroll = _this$props$enableAut === void 0 ? true : _this$props$enableAut, props = _objectWithoutProperties(_this$props, _excluded$4);
      var range3 = Day2.range(date2, {
        localizer
      });
      return import_react11.default.createElement(TimeGrid, Object.assign({}, props, {
        range: range3,
        eventOffset: 10,
        localizer,
        min: min2,
...
var Week = function(_React$Component) {
  ...
  _createClass(Week2, [{
    key: "render",
    value: function render() {
      var _this$props = this.props, date2 = _this$props.date, localizer = _this$props.localizer, _this$props$min = _this$props.min, min2 = _this$props$min === void 0 ? localizer.startOf(new Date(), "day") : _this$props$min, _this$props$max = _this$props.max, max2 = _this$props$max === void 0 ? localizer.endOf(new Date(), "day") : _this$props$max, _this$props$scrollToT = _this$props.scrollToTime, scrollToTime = _this$props$scrollToT === void 0 ? localizer.startOf(new Date(), "day") : _this$props$scrollToT, _this$props$enableAut = _this$props.enableAutoScroll, enableAutoScroll = _this$props$enableAut === void 0 ? true : _this$props$enableAut, props = _objectWithoutProperties(_this$props, _excluded$3);
...
var WorkWeek = function(_React$Component) {
  ...
  _createClass(WorkWeek2, [{
    key: "render",
    value: function render() {
      var _this$props = this.props, date2 = _this$props.date, localizer = _this$props.localizer, _this$props$min = _this$props.min, min2 = _this$props$min === void 0 ? localizer.startOf(new Date(), "day") : _this$props$min, _this$props$max = _this$props.max, max2 = _this$props$max === void 0 ? localizer.endOf(new Date(), "day") : _this$props$max, _this$props$scrollToT = _this$props.scrollToTime, scrollToTime = _this$props$scrollToT === void 0 ? localizer.startOf(new Date(), "day") : _this$props$scrollToT, _this$props$enableAut = _this$props.enableAutoScroll, enableAutoScroll = _this$props$enableAut === void 0 ? true : _this$props$enableAut, props = _objectWithoutProperties(_this$props, _excluded$2);
...
function Agenda(_ref) {
  ...
  var headerRef = (0, import_react11.useRef)(null);
  var dateColRef = (0, import_react11.useRef)(null);
  var timeColRef = (0, import_react11.useRef)(null);
  var contentRef = (0, import_react11.useRef)(null);
  var tbodyRef = (0, import_react11.useRef)(null);
  (0, import_react11.useEffect)(function() {
    _adjustHeader();
  });
  var renderDay = function renderDay2(day2, events2, dayKey) {
    ...
    return events2.map(function(event, idx) {
      ...
      var first = idx === 0 ? import_react11.default.createElement("td", {
        rowSpan: events2.length,
        className: "rbc-agenda-date-cell"
      }, AgendaDate ? import_react11.default.createElement(AgendaDate, {
        day: day2,
        label: dateLabel
      }) : dateLabel) : false;
      ...
      }, first, import_react11.default.createElement("td", {
        className: "rbc-agenda-time-cell"
      }, timeRangeLabel(day2, event)), import_react11.default.createElement("td", {
  ...
  var timeRangeLabel = function timeRangeLabel2(day2, event) {
    ...
    }, TimeComponent ? import_react11.default.createElement(TimeComponent, {
      event,
      day: day2,
      label
    }) : label);
  ...
  }, events.length !== 0 ? import_react11.default.createElement(import_react11.default.Fragment, null, import_react11.default.createElement("table", {
    ref: headerRef,
    className: "rbc-agenda-table"
  }, import_react11.default.createElement("thead", null, import_react11.default.createElement("tr", null, import_react11.default.createElement("th", {
    className: "rbc-header",
    ref: dateColRef
  }, messages2.date), import_react11.default.createElement("th", {
    className: "rbc-header",
    ref: timeColRef
  }, messages2.time), import_react11.default.createElement("th", {
    className: "rbc-header"
  }, messages2.event)))), import_react11.default.createElement("div", {
    className: "rbc-agenda-content",
    ref: contentRef
  }, import_react11.default.createElement("table", {
    className: "rbc-agenda-table"
  }, import_react11.default.createElement("tbody", {
    ref: tbodyRef
...
var Toolbar = function(_React$Component) {
  ...
  _createClass(Toolbar2, [{
    ...
    value: function render() {
      ...
      }, messages2.today), import_react11.default.createElement("button", {
        type: "button",
        onClick: this.navigate.bind(null, navigate.PREVIOUS)
      }, messages2.previous), import_react11.default.createElement("button", {
        type: "button",
        onClick: this.navigate.bind(null, navigate.NEXT)
      }, messages2.next)), import_react11.default.createElement("span", {
        className: "rbc-toolbar-label"
      }, label), import_react11.default.createElement("span", {
        className: "rbc-btn-group"
...
var Calendar = function(_React$Component) {
  ...
  _createClass(Calendar2, [{
    ...
    value: function render() {
      ...
      return import_react11.default.createElement("div", Object.assign({}, elementProps, {
        className: clsx_m_default(className, "rbc-calendar", props.rtl && "rbc-rtl"),
        style
      }), toolbar && import_react11.default.createElement(CalToolbar, {
        date: current,
        view,
        views: viewNames2,
        label,
        ...
        localizer
      }), import_react11.default.createElement(View, Object.assign({}, props, {
        events,
        backgroundEvents,
        date: current,
        getNow: getNow2,
...
var weekRangeFormat$3 = function weekRangeFormat2(_ref, culture, local) {
  var start = _ref.start, end = _ref.end;
  return local.format(start, "MMMM dd", culture) + " \u2013 " + local.format(end, local.eq(start, end, "month") ? "dd" : "MMMM dd", culture);
};
var dateRangeFormat$3 = function dateRangeFormat2(_ref2, culture, local) {
  var start = _ref2.start, end = _ref2.end;
  return local.format(start, "D", culture) + " \u2013 " + local.format(end, "D", culture);
};
var timeRangeFormat$3 = function timeRangeFormat2(_ref3, culture, local) {
  var start = _ref3.start, end = _ref3.end;
  return local.format(start, "t", culture) + " \u2013 " + local.format(end, "t", culture);
};
var timeRangeStartFormat$3 = function timeRangeStartFormat2(_ref4, culture, local) {
  var start = _ref4.start;
  return local.format(start, "t", culture) + " \u2013 ";
};
var timeRangeEndFormat$3 = function timeRangeEndFormat2(_ref5, culture, local) {
  var end = _ref5.end;
...
function luxon(DateTime) {
  ...
  function startOfDT() {
    var date2 = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : new Date();
    var unit = arguments.length > 1 ? arguments[1] : void 0;
    var datePart = fixUnit(unit);
    if (datePart) {
...
var dateRangeFormat$2 = function dateRangeFormat3(_ref, culture, local) {
  var start = _ref.start, end = _ref.end;
  return local.format(start, "d", culture) + " \u2013 " + local.format(end, "d", culture);
};
var timeRangeFormat$2 = function timeRangeFormat3(_ref2, culture, local) {
  var start = _ref2.start, end = _ref2.end;
  return local.format(start, "t", culture) + " \u2013 " + local.format(end, "t", culture);
};
var timeRangeStartFormat$2 = function timeRangeStartFormat3(_ref3, culture, local) {
  var start = _ref3.start;
  return local.format(start, "t", culture) + " \u2013 ";
};
var timeRangeEndFormat$2 = function timeRangeEndFormat3(_ref4, culture, local) {
  var end = _ref4.end;
  return " \u2013 " + local.format(end, "t", culture);
};
var weekRangeFormat$2 = function weekRangeFormat3(_ref5, culture, local) {
...
var dateRangeFormat$1 = function dateRangeFormat4(_ref, culture, local) {
  var start = _ref.start, end = _ref.end;
...
var timeRangeFormat$1 = function timeRangeFormat4(_ref2, culture, local) {
  var start = _ref2.start, end = _ref2.end;
  return local.format(start, {
    time: "short"
  }, culture) + " \u2013 " + local.format(end, {
...
var timeRangeStartFormat$1 = function timeRangeStartFormat4(_ref3, culture, local) {
  var start = _ref3.start;
  return local.format(start, {
    time: "short"
  }, culture) + " \u2013 ";
};
var timeRangeEndFormat$1 = function timeRangeEndFormat4(_ref4, culture, local) {
  var end = _ref4.end;
  return " \u2013 " + local.format(end, {
    time: "short"
  }, culture);
};
var weekRangeFormat$1 = function weekRangeFormat4(_ref5, culture, local) {
  var start = _ref5.start, end = _ref5.end;
  return local.format(start, "MMM dd", culture) + " \u2013 " + local.format(end, eq(start, end, "month") ? "dd" : "MMM dd", culture);
};
var formats$1 = {
...
var dateRangeFormat5 = function dateRangeFormat6(_ref, culture, local) {
  var start = _ref.start, end = _ref.end;
  return "".concat(local.format(start, "P", culture), " \u2013 ").concat(local.format(end, "P", culture));
};
var timeRangeFormat5 = function timeRangeFormat6(_ref2, culture, local) {
  var start = _ref2.start, end = _ref2.end;
  return "".concat(local.format(start, "p", culture), " \u2013 ").concat(local.format(end, "p", culture));
};
var timeRangeStartFormat5 = function timeRangeStartFormat6(_ref3, culture, local) {
  var start = _ref3.start;
  return "".concat(local.format(start, "h:mma", culture), " \u2013 ");
};
var timeRangeEndFormat5 = function timeRangeEndFormat6(_ref4, culture, local) {
  var end = _ref4.end;
  return " \u2013 ".concat(local.format(end, "h:mma", culture));
};
var weekRangeFormat5 = function weekRangeFormat6(_ref5, culture, local) {
  var start = _ref5.start, end = _ref5.end;
...
var formats = {
  ...
  dayFormat: "dd eee",
  weekdayFormat: "cccc",
  selectRangeFormat: timeRangeFormat5,
  eventTimeRangeFormat: timeRangeFormat5,
  eventTimeRangeStartFormat: timeRangeStartFormat5,
  eventTimeRangeEndFormat: timeRangeEndFormat5,
  timeGutterFormat: "p",
  monthHeaderFormat: "MMMM yyyy",
  dayHeaderFormat: "cccc MMM dd",
  dayRangeHeaderFormat: weekRangeFormat5,
  agendaHeaderFormat: dateRangeFormat5,
  agendaDateFormat: "ccc MMM dd",
  agendaTimeFormat: "p",
  agendaTimeRangeFormat: timeRangeFormat5
};
